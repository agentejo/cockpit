...
riot.tag('cockpit-search', '<div name="autocomplete" class="uk-autocomplete uk-form-icon uk-form app-search"> <i class="uk-icon-search"></i> <input class="uk-width-1-1" type="text"> </div>', 'cockpit-search .uk-dropdown { min-width: 25vw; }', function(opts) {
