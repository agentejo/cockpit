...
class Collection {
    ...
    protected function _insert(&$document) {
        ...
        $data            = array("document" => json_encode($document, JSON_NUMERIC_CHECK | JSON_UNESCAPED_UNICOD));
    ...
    public function update($criteria, $data) {
        ...
        foreach($result as &$doc) {
            ...
            $sql = "UPDATE ".$this->name." SET document=".$this->database->connection->quote(json_encode($document,JSON_NUMERIC_CHECK | JSON_UNESCAPED_UNICOD))." WHERE id=".$doc["id"];
